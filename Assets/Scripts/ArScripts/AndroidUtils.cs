...
public class AndroidUtils : MonoBehaviour
{
    ...
    private const string VIDEO_NAME = "Record", GALLERY_PATH = "/../../../../DCIM/ArAppRecordings/";
    ...
    public static AndroidUtils Singleton;
    ...
    private void Start()
    {
        ...
        using (AndroidJavaClass unityClass = new AndroidJavaClass("com.unity3d.player.UnityPlayer"))
        {
			...
			androidRecorder.Call("setUpSaveFolder","imp Ar App Rec");//custom your save folder to Movies/Tee, by defaut it will use Movies/AndroidUtils
